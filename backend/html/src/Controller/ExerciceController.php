...
#[Route('/api/exercices', name: 'api_exercices_')]
class ExerciceController extends AbstractController
{
    ...
    public function list(Request $request, EntityManagerInterface $em): JsonResponse
    {
        ...
        $queryBuilder = $em->getRepository(Exercice::class)->createQueryBuilder('e');

        if ($chapitreId) {
            $queryBuilder
                ->where('e.chapitre = :chapitreId')
        ...
        $data = array_map(function (Exercice $exercice) {
            return [
                'id' => $exercice->getId(),
                'contenu' => $exercice->getContenu(),
                'ordre' => $exercice->getOrdre(),
                'chapitre_id' => $exercice->getChapitre()->getId(),
    ...
    public function create(Request $request, EntityManagerInterface $em): JsonResponse
    {
        ...
        $exercice->setContenu($data['contenu']);
        $exercice->setChapitre($chapitre);
        $exercice->setOrdre($data['ordre'] ?? null);
    ...
    public function update(int $id, Request $request, EntityManagerInterface $em): JsonResponse
    {
        ...
        if (!$exercice) {
            return $this->corsResponse(new JsonResponse(['message' => 'Exercice non trouvé.'], 404));
        }
    ...
    public function delete(int $id, Request $request, EntityManagerInterface $em): JsonResponse
    {
        ...
        return $this->corsResponse(new JsonResponse(['message' => 'Exercice supprimé avec succès.'], 200));
    }
